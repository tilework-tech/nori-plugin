...
| registrar.ts | `searchPackages()`, `getPackument()`, `downloadTarball()` | Used by nori-registry-search and nori-registry-download slash commands |
